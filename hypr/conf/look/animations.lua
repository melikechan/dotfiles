...
--- Looks (Animtations) ---
---------------------------
-- Taken from https://github.com/mylinuxforwork/dotfiles/blob/main/dotfiles/.config/hypr/conf/animations/animations-fast.lua and a bit tweaked
...
hl.animation({ leaf = "fadeIn", enabled = true, speed = 2.5, bezier = "md3_accel" })
